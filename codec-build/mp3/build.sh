...
docker run --rm \
  ...
  bash -lc '
    ...
    emcc /bridge/bridge.c \
      ...
      -Wl,--strip-all \
      -Wl,--export=dsub_mp3_abi_version \
      -Wl,--export=dsub_mp3_create \
      -Wl,--export=dsub_mp3_last_create_error \
      -Wl,--export=dsub_mp3_prepare_pcm \
      -Wl,--export=dsub_mp3_encode \
      -Wl,--export=dsub_mp3_flush \
      -Wl,--export=dsub_mp3_output \
      -Wl,--export=dsub_mp3_reset \
      -Wl,--export=dsub_mp3_destroy \
      -o /work/out/mp3.wasm
  '
