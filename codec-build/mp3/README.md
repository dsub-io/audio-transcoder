...
3.100. It runs directly inside the existing dsub transcoder Worker and never
...
single JavaScript file. The dsub build retains LAME 3.100 and SIMD but uses
`-Oz -flto`, a stable `dsub_mp3_*` ABI, and standalone raw WASM. JavaScript
