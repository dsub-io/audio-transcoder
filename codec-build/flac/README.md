...
This directory contains the complete dsub-owned bridge, pinned build recipe,
...
The dsub bridge adds explicit destruction, checked allocations, reusable flush,
