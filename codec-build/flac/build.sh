...
EXPECTED_WASM_SHA256=e0b8951b63a3f324a188bfa2cdae1f5606dd723e303abe02cf7122892ae12b15
...
if [ "${1:-}" = "--compile" ]; then
  ...
  emcc "$REPOSITORY_ROOT/codec-build/flac/bridge.c" \
    ...
    -Wl,--export=dsub_flac_abi_version \
    -Wl,--export=dsub_flac_create \
    -Wl,--export=dsub_flac_last_create_error \
    -Wl,--export=dsub_flac_last_error \
    -Wl,--export=dsub_flac_prepare_pcm \
    -Wl,--export=dsub_flac_pcm \
    -Wl,--export=dsub_flac_encode \
    -Wl,--export=dsub_flac_output \
    -Wl,--export=dsub_flac_output_length \
    -Wl,--export=dsub_flac_frame_count \
    -Wl,--export=dsub_flac_frame_size \
    -Wl,--export=dsub_flac_frame_samples \
    -Wl,--export=dsub_flac_header \
    -Wl,--export=dsub_flac_header_length \
    -Wl,--export=dsub_flac_finish \
    -Wl,--export=dsub_flac_reset \
    -Wl,--export=dsub_flac_destroy \
...
BUILD_ROOT=$(mktemp -d "${TMPDIR:-/tmp}/dsub-flac.XXXXXX")
