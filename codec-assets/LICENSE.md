...
Dsub-authored packaging, bridge, and build material is covered by the
PolyForm Noncommercial License 1.0.0 reproduced in the repository root
[`LICENSE.md`](../LICENSE.md) and staged as `LICENSE.DSUB.md` in local fixtures,
unless a file or notice says otherwise. Third-party components retain their own
licenses, and the dsub license does not restrict rights granted directly by
those licenses.
...
```text
https://github.com/dsub-io/audio-transcoder/tree/v<package-version>
```
