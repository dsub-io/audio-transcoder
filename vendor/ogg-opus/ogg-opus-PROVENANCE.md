...
git clone --depth 1 --branch 4.0.20 \
  https://github.com/emscripten-core/emsdk.git /tmp/dsub-emsdk-4.0.20
/tmp/dsub-emsdk-4.0.20/emsdk install 4.0.20
/tmp/dsub-emsdk-4.0.20/emsdk activate 4.0.20
OGG_OPUS_EMSDK_ROOT=/tmp/dsub-emsdk-4.0.20 \
...
Runtime controls are deliberately fixed: serial `0x44535542` (`DSUB`), 20 ms
