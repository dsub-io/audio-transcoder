...
EXPECTED_FAST_SHA256=bab40503bf0ed441421a5634b2e2c98aaad5e6b0bf663461fc5b19e779985e27
EXPECTED_BALANCED_SHA256=2134656307e866675cbd502030627fa495d80ee77590ca50f29c40ce92c2d226
EXPECTED_BEST_SHA256=dadecff97059b0e7847990ee180517cccdbe6db3e24d4018c33904620a49730d
...
if [ "${1:-}" = "--compile" ]; then
  ...
  build_quality() {
    ...
    emcc "$REPOSITORY_ROOT/vendor/resampler/libsamplerate-bridge.c" \
      ...
      -DDSUB_CONVERTER_TYPE="$converter_type" \
      ...
      -Wl,--export=dsub_resampler_create \
      -Wl,--export=dsub_resampler_last_create_error \
      -Wl,--export=dsub_resampler_prepare \
      -Wl,--export=dsub_resampler_input \
      -Wl,--export=dsub_resampler_output \
      -Wl,--export=dsub_resampler_process \
      -Wl,--export=dsub_resampler_input_frames_used \
      -Wl,--export=dsub_resampler_output_frames_gen \
      -Wl,--export=dsub_resampler_destroy \
...
BUILD_ROOT=$(mktemp -d "${TMPDIR:-/tmp}/dsub-resampler.XXXXXX")
