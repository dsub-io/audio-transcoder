...
EXPECTED_WASM_SHA256=b05bdb49b04962aef0e037e66115d799cbc1112d7a3e02e0d0de76b6a6b04f11
...
BUILD_ROOT=$(mktemp -d "${TMPDIR:-/tmp}/dsub-ogg-opus.XXXXXX")
...
emcc "$REPOSITORY_ROOT/vendor/ogg-opus/ogg-opus-libopusenc-bridge.c" \
  ...
  -Wl,--export=dsub_ogg_opus_create \
  -Wl,--export=dsub_ogg_opus_last_create_error \
  -Wl,--export=dsub_ogg_opus_pcm \
  -Wl,--export=dsub_ogg_opus_pcm_capacity_frames \
  -Wl,--export=dsub_ogg_opus_max_page_bytes \
  -Wl,--export=dsub_ogg_opus_write \
  -Wl,--export=dsub_ogg_opus_drain \
  -Wl,--export=dsub_ogg_opus_pull_page \
  -Wl,--export=dsub_ogg_opus_page \
  -Wl,--export=dsub_ogg_opus_page_length \
  -Wl,--export=dsub_ogg_opus_eos_seen \
  -Wl,--export=dsub_ogg_opus_destroy \
  -o "$WASM_OUTPUT"
