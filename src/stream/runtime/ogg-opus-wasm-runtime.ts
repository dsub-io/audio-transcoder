...
export interface OggOpusWasmExports extends WebAssembly.Exports {
  ...
  readonly dsub_ogg_opus_create: (
    channels: number,
    bitrateBps: number,
  ) => number;
  readonly dsub_ogg_opus_destroy: (handle: number) => void;
  readonly dsub_ogg_opus_drain: (handle: number) => number;
  readonly dsub_ogg_opus_eos_seen: (handle: number) => number;
  readonly dsub_ogg_opus_last_create_error: () => number;
  readonly dsub_ogg_opus_max_page_bytes: () => number;
  readonly dsub_ogg_opus_page: (handle: number) => number;
  readonly dsub_ogg_opus_page_length: (handle: number) => number;
  readonly dsub_ogg_opus_pcm: (handle: number) => number;
  readonly dsub_ogg_opus_pcm_capacity_frames: () => number;
  readonly dsub_ogg_opus_pull_page: (handle: number) => number;
  readonly dsub_ogg_opus_write: (handle: number, frames: number) => number;
}
...
function assertExports(
  ...
  const functions = [
    'dsub_ogg_opus_create',
    'dsub_ogg_opus_destroy',
    'dsub_ogg_opus_drain',
    'dsub_ogg_opus_eos_seen',
    'dsub_ogg_opus_last_create_error',
    'dsub_ogg_opus_max_page_bytes',
    'dsub_ogg_opus_page',
    'dsub_ogg_opus_page_length',
    'dsub_ogg_opus_pcm',
    'dsub_ogg_opus_pcm_capacity_frames',
    'dsub_ogg_opus_pull_page',
    'dsub_ogg_opus_write',
  ] as const;
